...
(function (RelationshipTypes) {
    RelationshipTypes["OfficeDocument"] = "http://schemas.openxmlformats.org/officeDocumet/2006/relationships/officeDocument";
...
class HtmlRenderer {
    ...
    renderDefaultStyle() {
        ...
        var styleText = `
.${c}-wrapper { background: #fff; padding: 0px; padding-bottom: 0px; display: flex; flex-flow: column; align-items: stretch; } 
.${c}-wrapper>section.${c} { background: white; margin-bottom: 30px; }
.${c} { color: black; }
